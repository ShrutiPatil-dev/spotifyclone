    ...
    <div className='h-[10%] bg-black flex justify-between items-center text-white px-4'>
        ...
        <div className='flex flex-col items-center gap-1 m-auto'>
            <div className="flex gap-4">
                ...
                <img className='w-4 cursor-pointer' onClick={previous} src={assets.prev_icon} alt="prev-icon"/>
                {
                    playStatus ?
                ...
                <img className='w-4 cursor-pointer' onClick={next} src={assets.next_icon} alt="next-icon"/>
                <img className='w-4 cursor-pointer' src={assets.loop_icon} alt="loop-icon"/>

            </div>
            <div className="flex items-center gap-5">
                <p>{time.currentTime.minute}:{time.currentTime.second}</p>
                <div ref={seekBg} onClick={seekSong} className='w-[50vw] max-w-[400] bg-gray-300 rounded-full cursor-pointer'>
